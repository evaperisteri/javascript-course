...
window.addEventListener('DOMContentLoaded', function(){
  this.document.querySelector('#btnDcr').addEventListener('click', onDecreaseClicked)
  //.addEventListener('click', () => onDecreaseClicked())
...
//handler - controller
function onDecreaseClicked(){   //data bindind
  decreaseCounter()             //data valitadion
}
...
// let counter = 0;
// const btnDecr = document.getElementById('btnDcr')
